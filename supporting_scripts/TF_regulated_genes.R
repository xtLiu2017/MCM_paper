...
p4 = ggplot(data = ANAC_df, aes(x = pkt1 + 3)) + 
  ...
  labs(fill = "Gene set") + theme(legend.position = 'none',plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")) + ggtitle("ANAC regulated genes") + 
...
p7 = ggplot(data = CAMTA1_df, aes(x = pkt1 + 3)) + 
  ...
  labs(fill = "Gene set") + theme(legend.position = 'none',plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")) + ggtitle("CAMTA1 regulated genes") + 
...
p10 = ggplot(data = WRKY_df, aes(x = pkt1 + 3)) + 
  ...
  labs(fill = "Gene set") + theme(legend.position = 'none',plot.margin = unit(c(0.3,0.3,0.3,0.3), "cm")) + ggtitle("WRKY regulated genes") + 
...
jpeg("figures/TF_regulated_genes.jpeg",width = 350, height = 150, unit = 'mm',res = 400 )
